...
@app.route('/home', defaults={'company_filter': None}) # - added
@app.route('/home/<company_filter>')
def home(company_filter):
    cursor = db.cursor()
    ...
    return render_template('home.html', data=data, company_filter=company_filter)
